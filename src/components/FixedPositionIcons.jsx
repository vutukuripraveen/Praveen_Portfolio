    ...
    >
      <Stack spacing={2}>
        <IconButton
          ...
          onClick={() =>
            handleUrl("https://www.linkedin.com/in/ranjithkumarseekolu/")
          }
        >
        ...
        <IconButton
          aria-label="github"
          onClick={() => handleUrl("https://github.com/RanjithKumarSeekolu")}
        >
          <GitHub className="w-5 h-5" />
        </IconButton>
        <IconButton
          aria-label="whatsapp"
          onClick={() => handleUrl("https://wa.me/+919182176879")}
        >
          <WhatsApp className="w-5 h-5" />
        </IconButton>
        <IconButton
          aria-label="Email"
          onClick={() => handleUrl("mailto:ranjithkumarseekolu@gmail.com")}
        >
